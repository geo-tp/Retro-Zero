    ...
    const std::vector<std::pair<std::string, std::string>> &systems)
{
    ...
    return std::string(
        ...
        "<li>For Neo Geo, upload BIOS <strong>neogeo.zip</strong> to the Neo Geo system.</li>"
        "<li>For Naomi / Atomiswave, upload BIOS <strong>naomi.zip</strong>, <strong>naomi2.zip</strong>, and <strong>awbios.zip</strong> to the Naomi / Atomiswave system.</li>"
